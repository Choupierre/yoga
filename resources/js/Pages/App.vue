...
<template>
    <div class="w-screen h-screen fixed z-10 top-0 left-0 flex justify-center items-center" v-if="modal">
        <div class="bg-black w-screen h-screen fixed top-0 left-0 opacity-50 absolute"></div>
        ...
        <div class="container mx-auto">
            <div class="flex justify-center gap-4 mt-4 mb-8" v-if="auth?.admin">
                ...
                <label class="inline-flex items-center cursor-pointer">
                    ...
                    <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Dates à venir</span>
                </label>
            </div>
